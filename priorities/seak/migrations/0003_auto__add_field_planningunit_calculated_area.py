...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanningUnit.calculated_area'
        db.add_column('seak_planningunit', 'calculated_area',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanningUnit.calculated_area'
        db.delete_column('seak_planningunit', 'calculated_area')
