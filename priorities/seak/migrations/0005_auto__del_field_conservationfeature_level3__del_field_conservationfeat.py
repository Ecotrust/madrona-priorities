...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConservationFeature.level3'
        db.delete_column('seak_conservationfeature', 'level3')

        # Deleting field 'ConservationFeature.level4'
        db.delete_column('seak_conservationfeature', 'level4')

        # Deleting field 'ConservationFeature.level5'
        db.delete_column('seak_conservationfeature', 'level5')


    def backwards(self, orm):
        # Adding field 'ConservationFeature.level3'
        db.add_column('seak_conservationfeature', 'level3',
                      self.gf('django.db.models.fields.CharField')(max_length=99, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConservationFeature.level4'
        db.add_column('seak_conservationfeature', 'level4',
                      self.gf('django.db.models.fields.CharField')(max_length=99, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConservationFeature.level5'
        db.add_column('seak_conservationfeature', 'level5',
                      self.gf('django.db.models.fields.CharField')(max_length=99, null=True, blank=True),
                      keep_default=False)
