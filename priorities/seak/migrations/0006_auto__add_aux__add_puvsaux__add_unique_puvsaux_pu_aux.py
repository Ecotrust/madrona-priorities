...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('seak', ['Aux'])

        # Adding model 'PuVsAux'
        db.create_table('seak_puvsaux', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seak.PlanningUnit'])),
            ('aux', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seak.Aux'])),
            ('value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('seak', ['PuVsAux'])

        # Adding unique constraint on 'PuVsAux', fields ['pu', 'aux']
        db.create_unique('seak_puvsaux', ['pu_id', 'aux_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PuVsAux', fields ['pu', 'aux']
        db.delete_unique('seak_puvsaux', ['pu_id', 'aux_id'])

        # Deleting model 'Aux'
        db.delete_table('seak_aux')

        # Deleting model 'PuVsAux'
        db.delete_table('seak_puvsaux')
