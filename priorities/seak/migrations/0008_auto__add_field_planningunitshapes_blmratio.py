...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlanningUnitShapes.blmratio'
        db.add_column('seak_planningunitshapes', 'blmratio', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlanningUnitShapes.blmratio'
        db.delete_column('seak_planningunitshapes', 'blmratio')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 9, 41, 7, 136241)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 9, 41, 7, 136132)'}),
        ...
        'seak.planningunitshapes': {
            ...
            'blmratio': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        'seak.puvsaux': {
            'Meta': {'unique_together': "(('pu', 'aux'),)", 'object_name': 'PuVsAux'},
            'aux': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seak.Aux']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seak.PlanningUnit']"}),
