...
<div class="tabs">
    ...
    <p> 
     The <strong>goal proportion</strong> is the proportion of the species viability score you want to represent in your scenario. 
    ...
    <p> 
    The <strong>importance weighting</strong> is the subjective value of meeting that goal. 
