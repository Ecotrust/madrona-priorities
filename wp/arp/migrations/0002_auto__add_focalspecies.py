...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FocalSpecies'
        db.create_table('arp_focalspecies', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('common_name', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('species_name', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('level1', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('level2', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('level3', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('level4', self.gf('django.db.models.fields.CharField')(max_length=99)),
            ('level5', self.gf('django.db.models.fields.CharField')(max_length=99)),
        ))
        db.send_create_signal('arp', ['FocalSpecies'])


    def backwards(self, orm):
        
        # Deleting model 'FocalSpecies'
        db.delete_table('arp_focalspecies')
    ...
    models = {
        ...
        'arp.focalspecies': {
            ...
            'level2': ('django.db.models.fields.CharField', [], {'max_length': '99'}),
            'level3': ('django.db.models.fields.CharField', [], {'max_length': '99'}),
            'level4': ('django.db.models.fields.CharField', [], {'max_length': '99'}),
            'level5': ('django.db.models.fields.CharField', [], {'max_length': '99'}),
